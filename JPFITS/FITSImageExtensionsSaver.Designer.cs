namespace JPFITS
{
	partial class FITSImageExtensionsSaver
	{
		...
		private void InitializeComponent()
		{
			...
			this.CancelBtn.Location = new System.Drawing.Point(177, 248);
			...
			this.extensionsGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[2] { this.EXTNAME, this.PRECISION });
			this.extensionsGridView.Location = new System.Drawing.Point(12, 25);
			...
			this.extensionsGridView.Size = new System.Drawing.Size(159, 248);
			...
			this.PRECISION.Items.AddRange(new object[8] {
			...
			// FirstAsPrimaryChck
			// 
			this.FirstAsPrimaryChck.Location = new System.Drawing.Point(177, 25);
			this.FirstAsPrimaryChck.Name = "FirstAsPrimaryChck";
			this.FirstAsPrimaryChck.Size = new System.Drawing.Size(89, 45);
			...
			this.FirstAsPrimaryChck.CheckedChanged += new System.EventHandler(FirstAsPrimaryChck_CheckedChanged);
			// 
			// SaveBtn
			// 
			this.SaveBtn.DialogResult = System.Windows.Forms.DialogResult.OK;
			this.SaveBtn.Location = new System.Drawing.Point(177, 220);
			...
			// AppendIntoFileChck
			// 
			this.AppendIntoFileChck.Location = new System.Drawing.Point(177, 179);
			this.AppendIntoFileChck.Name = "AppendIntoFileChck";
			this.AppendIntoFileChck.Size = new System.Drawing.Size(89, 35);
			...
			this.AppendIntoFileChck.CheckedChanged += new System.EventHandler(AppendIntoFileChck_CheckedChanged);
			// 
			// groupBox1
			// 
			...
			this.GlobalPrecisionDrop.Items.AddRange(new object[9] {
				"int16", "uint16", "int32", "uint32",
					"int64", "uint64", "float", "double", "(reset)"
   			});
			this.GlobalPrecisionDrop.Location = new System.Drawing.Point(4, 126);
			this.GlobalPrecisionDrop.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.GlobalPrecisionDrop.Name = "GlobalPrecisionDrop";
			this.GlobalPrecisionDrop.Size = new System.Drawing.Size(87, 21);
			this.GlobalPrecisionDrop.TabIndex = 1;
			this.GlobalPrecisionDrop.SelectedIndexChanged += new System.EventHandler(GlobalPrecisionDrop_SelectedIndexChanged);
			// 
			// ViewEditPrimaryHeaderBtn
			// 
			this.ViewEditPrimaryHeaderBtn.Location = new System.Drawing.Point(4, 55);
			this.ViewEditPrimaryHeaderBtn.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
			this.ViewEditPrimaryHeaderBtn.Name = "ViewEditPrimaryHeaderBtn";
			this.ViewEditPrimaryHeaderBtn.Size = new System.Drawing.Size(86, 47);
			...
			this.ViewEditPrimaryHeaderBtn.Click += new System.EventHandler(ViewEditPrimaryHeaderBtn_Click);
			// 
			...
			this.TopMost = true;
			this.MouseEnter += new System.EventHandler(ImageExtensionsSaver_MouseEnter);
