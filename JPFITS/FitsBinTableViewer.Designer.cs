namespace JPFITS
{
	partial class FitsBinTableViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.ExtensionTableGrid.CellMouseClick += new System.Windows.Forms.DataGridViewCellMouseEventHandler(this.ExtensionTableGrid_CellMouseClick);
			...
			this.MenuChooseTableEntries.DropDownItemClicked += new System.Windows.Forms.ToolStripItemClickedEventHandler(this.MenuChooseTableEntries_DropDownItemClicked);
			this.MenuChooseTableEntries.Click += new System.EventHandler(this.MenuChooseTableEntries_Click);
			this.MenuChooseTableEntries.MouseLeave += new System.EventHandler(this.MenuChooseTableEntries_MouseLeave);
			// 
			// ViewAllChck
			// 
			...
			this.Shown += new System.EventHandler(this.FitsExtensionTableViewer_Shown);
			...
			this.MouseEnter += new System.EventHandler(this.FitsExtensionTableViewer_MouseEnter);
			this.MouseHover += new System.EventHandler(this.FitsExtensionTableViewer_MouseHover);
